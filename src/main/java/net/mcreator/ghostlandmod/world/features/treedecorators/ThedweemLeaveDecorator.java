...
public class ThedweemLeaveDecorator extends LeaveVineDecorator {
	public static final ThedweemLeaveDecorator INSTANCE = new ThedweemLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("thedweem_tree_leave_decorator");
