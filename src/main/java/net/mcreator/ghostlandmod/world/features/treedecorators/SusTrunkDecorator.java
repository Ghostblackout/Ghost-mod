...
public class SusTrunkDecorator extends TrunkVineDecorator {
	public static final SusTrunkDecorator INSTANCE = new SusTrunkDecorator();
	public static com.mojang.serialization.Codec<SusTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sus_tree_trunk_decorator");
